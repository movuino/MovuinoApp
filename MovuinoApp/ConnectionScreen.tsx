...
type ConnectionScreenProps = NativeStackScreenProps<
RootStackParamList,
'Connecting'
>;

const ConnectionScreen: FunctionComponent<ConnectionScreenProps> = ({navigation, route}) => {
    const {deviceSelected, deviceConnected, setDeviceConnected} = useContext(AppContext)
    ...
    const onConnected = () => {
        ...
        navigation.navigate(HOME_PAGE as never, {} as never);
      };
    ...
    const connect = async () => {
        ...
        try {
            ...
            if (e instanceof BleError && e.message === "Operation was cancelled") {} // Thrown if cancel button is pressed
            else if (e instanceof Error) {console.error(e); return onConnectionError(e.message);} // other errors
